...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setError(
        err.response?.data?.detail || "Hubo un error al iniciar sesión. Intenta de nuevo."
      );
    }
  };
    ...
    >
      <div className="absolute inset-0 bg-white/30 backdrop-blur-xs flex items-center justify-center px-4 space-y-4">
        <div className="bg-white px-8 py-16 rounded-xl shadow-lg max-w-md w-full text-center">
          ...
          <div className="my-4 text-gray-400 text-sm">o continúa con</div>
          ...
          <p className="text-xs text-gray-500 mt-4">
            ...
            <a href="#" className="underline text-black">Términos de servicio</a> y{" "}
            <a href="#" className="underline text-black">Política de privacidad</a>.
          </p>
        </div>
      </div>
    </div>
